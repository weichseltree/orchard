...
describe("the designed observatory", () => {
  it("builds every footprint with explicit architectural provenance, no textures or lights", () => {
    // The palace's thirteen chambers and cells (coarsen's chamber went on 2026-09-16), the cellar venue's seven with its two garden courts (2026-09-17), arcedit's area of six, and quantumflow's east wing of six.
