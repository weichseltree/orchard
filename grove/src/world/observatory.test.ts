...
describe("the designed observatory", () => {
  it("builds every footprint with explicit architectural provenance, no textures or lights", () => {
    // The palace's thirteen chambers and cells (coarsen's chamber went on 2026-09-16), the cellar venue's three, and arcedit's area of six (redesigned 2026-09-17).
    expect(shells).toHaveLength(22);
